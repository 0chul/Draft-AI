...
import { Upload, FileText, File as FileIcon, X, Plus, Play } from 'lucide-react';
  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8">
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-slate-800">RFP 및 참고자료 업로드</h2>
        <p className="text-slate-500 mt-2">고객사의 제안요청서(PDF, PPTX)와 관련 영업 메모를 모두 업로드하세요.</p>
      </div>
